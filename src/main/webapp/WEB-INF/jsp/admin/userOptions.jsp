...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <h4>姓名</h4>
        <input type="hidden" name="uerid" value="<c:out value="${adminUser.userid}"/>"/>
        <p><label for="userName">用户名</label>
            <input type="text" name="username" size="30" class="form-input" value="<c:out value="${adminUser.username}"/>"/></p>
        <p><label for="userNickName">昵称（必填）</label>
            <input type="text" name="displayname" size="30" class="form-input" value="<c:out value="${adminUser.displayName}"/>"/></p>
        <h4>联系信息</h4>
        <p><label for="mail">电子邮件（必填）</label>
            <input type="text" name="email" size="30" class="form-input" value="<c:out value="${adminUser.email}"/>"/></p>
        <p><label for="site">个人主页</label>
            <input type="text" name="homepage" size="30" class="form-input" value="<c:out value="${adminUser.homePageUrl}"/>"/></p>
            <p><label>原密码</label><input type="password" name="prvpass" size="20" class="form-input-pwd"/></p>
