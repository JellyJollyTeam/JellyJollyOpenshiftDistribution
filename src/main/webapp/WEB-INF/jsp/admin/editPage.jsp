                ...
                <p>创建页面</p>
                    <div class="edit">
                        <form name="postPage" action="./page" method="post">
                            ...
                            <div class="edit-head">
                            <p>
                                <label for="passage-name">页面标题</label>
                                <input type="text" name="passage-name" class="form-input"/>
                            </p>
                            </div>
                            <textarea id="editor1" cols="20" rows="10" class="ckeditor"></textarea>
                            <p><input style="margin-left: 5px;" type="button" name="publish" value="发表" id="button-primary"/></p>
                        </form>
                    </div>
            </div>
            <div class="foot">
