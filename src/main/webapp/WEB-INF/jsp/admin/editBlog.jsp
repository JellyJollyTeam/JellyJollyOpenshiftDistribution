        ...
        <div class="panel">
            ...
            <form name="postBlog" action="./post" method="post" id="postBlog">
                <div class="edit">
                    <div class="edit-head">
                        <p>
                            <label for="passage-name">标题</label>
                            <input value="<c:out value="${blogpost.title}"/>" type="text" name="title" class="form-input"/>
                        </p>
                    </div>
                    <textarea id="editor1" name="content" cols="20" rows="2" class="ckeditor" value="<c:out value="${blogpost.content}"/>"><c:out value="${blogpost.content}"/></textarea>
                    <input style="margin-left:5px;"type="button" name="publish" value="发表" id="button-primary" />
                </div>
                <div class="panel2">
