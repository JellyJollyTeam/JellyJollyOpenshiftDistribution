        ...
        <div id="page">
            ...
            <div id="content">
                ...
                <form action="<c:url value="/install" />" method="post" id="commentform">
                    ...
                    <p>
                        <label for="subtitle" style="float: left; width: 100px">您的名字 *</label><input type="text" name="displayName" style="width: 200px" />
                    </p>
                    <p>
                        <label for="subtitle" style="float: left; width: 100px">您的邮箱 *</label><input type="text" name="email" style="width: 200px" />
                    </p>
                    <p>
